...
reason: "This E-mail is already exist!"
			 ...
			 */
            connection.query('insert into user(user_id_email, user_pw) values (?,?);', [id, pw], function (error, info) {
                if (error == null) {

                    connection.query('select * from user where user_idx=?;', [info.insertId], function (error, cursor) {
